...
public class ModdepTest implements Serializable {
	...
	@Id
	@Column(name="cod_test", unique=true, nullable=false, precision=131089)
	private long codTest;

	@Column(name="abdominales_min_test", precision=131089)
	private BigDecimal abdominalesMinTest;

	@Column(name="altura_test", precision=131089)
	private BigDecimal alturaTest;

	@Column(name="cardio_min_test", precision=131089)
	private BigDecimal cardioMinTest;

	@Column(name="fecha_test_test", precision=131089)
	private BigDecimal fechaTestTest;

	@Column(name="peso_test", precision=131089)
	private BigDecimal pesoTest;

	@Column(name="rendimiento_fisico_test", precision=131089)
	private BigDecimal rendimientoFisicoTest;

	@Column(name="velocidad_test", precision=131089)
